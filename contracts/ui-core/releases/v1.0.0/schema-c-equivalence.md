# v1.0.0 — Language-neutral schema ↔ C binding equivalence

Status: **RELEASED v1.0.0 — IMMUTABLE**.

Normative semantic source: `contract.md`.

Machine-readable schema: `schema.json`.

Released C binding: `uic_v1.h`.
...
The v1.0.0 release validation workflow checks:
...
The v1.0.0 schema, C binding and conformance vectors are immutable. A future semantic or ABI change MUST be published as a new contract release.
